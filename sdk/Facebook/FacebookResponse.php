...
class FacebookResponse
{
   ...
   * @return mixed
   */
  public function getGraphObject($type = 'sdk\Facebook\GraphObject') {
    $tmp = new GraphObject($this->responseData);
   ...
   * @return mixed
   */
  public function getGraphObjectList($type = 'sdk\Facebook\GraphObject') {
    $out = array();
    $data = $this->responseData->data;
    for ($i = 0; $i < count($data); $i++) {
      $tmp = new GraphObject($data[$i]);
      $out[] = $tmp->cast($type);
    }
    return $out;
  }
