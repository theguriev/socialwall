 ...
 * form for use sdk\in connection with the web services and APIs provided by
 * Facebook.
 *
 ...
 * FROM, OUT OF OR IN CONNECTION WITH THE SOFTWARE OR THE use sdk\OR OTHER
 * DEALINGS IN THE SOFTWARE.
 *
 */
namespace sdk\Facebook;
...
class GraphObject
{
  ...
  public function cast($type)
  {
    ...
    if (is_subclass_of($type, GraphObject::className())) {
      ...
      throw new FacebookSDKException(
        'Cannot cast to an object that is not a GraphObject subclass'.$type, 620
      );
    }
  }
   ...
   * @return mixed
   */
  public function getProperty($name, $type = 'sdk\Facebook\GraphObject')
  {
   ...
   * @return array
   */
  public function getPropertyAsArray($name, $type = 'sdk\Facebook\GraphObject')
  {
    $target = array();
