...
use sdk\Facebook\Entities\AccessToken;
use sdk\Facebook\Entities\SignedRequest;
...
class FacebookSession
{
   ...
   *
   * @param string $appId Application ID to use sdk\by default
   * @param string $appSecret App secret value to use sdk\by default
   */
